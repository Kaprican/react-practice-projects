...
export const User = ({avatar, email, first_name, last_name, onClick, isInvited}) => (
    <li>
        <div>
        ...
        {isInvited}
        <img className={`action ${isInvited ? "invited" : ""}`} src="/assets/plus.svg" alt="Action" onClick={onClick}/>
    </li>
);
